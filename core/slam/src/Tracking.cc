...
cv::Mat Tracking::GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const double &timestamp)
{
    ...
    Track();
    // cv::Mat tempmat=this->get_drawer()->DrawFrame().clone();
    // return tempmat;
    return mCurrentFrame.mTcw.clone();

}

cv::Mat Tracking::GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD,const cv::Mat & bi, const double &timestamp)//overwrite by myself
{
    mImRGB = imRGB;
    mImGray = imRGB;
    mImDepth = imD;
...
void Tracking::CreateNewKeyFrame()
{
    ...
    //mpPointCloudMapping->insertKeyFrame( pKF, this->mImRGB, this->mImDepth );    here I changed!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    mpPointCloudMapping->insertKeyFrame(pKF,this->mImRGB, this->mImDepth,this->BiImage);
    mnLastKeyFrameId = mCurrentFrame.mnId;
    mpLastKeyFrame = pKF;
}
